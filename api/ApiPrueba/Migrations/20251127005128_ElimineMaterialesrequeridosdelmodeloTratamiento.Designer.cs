...
namespace ApiPrueba.Migrations
{
    ...
    [Migration("20251127005128_ElimineMaterialesrequeridosdelmodeloTratamiento")]
    partial class ElimineMaterialesrequeridosdelmodeloTratamiento
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiPrueba.Models.AutorizacionSesiones", b =>
                {
                    ...
                    b.Property<int>("SesionesAprobadas")
                        .HasColumnType("int");

                    b.Property<int>("SesionesConsumidas")
                        .HasColumnType("int");
                    ...
                    b.ToTable("AutorizacionSesiones");
                });
            ...
            modelBuilder.Entity("ApiPrueba.Models.Cita", b =>
                {
                    ...
                    b.Property<int?>("OrdenMedicaIdOrdenMedica")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OrdenMedicaIdOrdenMedica");
            ...
            modelBuilder.Entity("ApiPrueba.Models.ContratoSeguro", b =>
                {
            ...
            modelBuilder.Entity("ApiPrueba.Models.EquiposRequeridos", b =>
                {
                    b.Property<int>("IdEquipoRequerido")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdEquipoRequerido"));
                    ...
                    b.HasKey("IdEquipoRequerido");

                    b.HasIndex("IdEquipo");

                    b.HasIndex("IdTipoServicio");

                    b.ToTable("EquiposRequeridos");
                });
            ...
            modelBuilder.Entity("ApiPrueba.Models.OrdenMedica", b =>
                {
                    b.Property<int>("IdOrdenMedica")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdOrdenMedica"));
                    ...
                    b.Property<int?>("NumeroSesionesAutorizadas")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("TratamientoOrdenado")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("ApiPrueba.Models.Sala", b =>
                {
                    b.Property<int>("IdSala")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiPrueba.Models.TipoServicio", b =>
                {
                    b.Property<int>("IdTipoServicio")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("CompatibleConEPS")
                        .HasColumnType("bit");

                    b.Property<bool>("CompatibleConPrepagadas")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("DocumentosNecesarios")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<int>("DuracionEstandarMin")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("TipoSalaNecesaria")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("ApiPrueba.Models.TipoServicioEspecialidad", b =>
                {
                    b.Property<int>("IdTipoServicioEspecialidad")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdTipoServicioEspecialidad"));
                    ...
                    b.HasKey("IdTipoServicioEspecialidad");

                    b.HasIndex("IdEspecialidad");

                    b.HasIndex("IdTipoServicio");

                    b.ToTable("TipoServicioEspecialidad");
                });
            ...
            modelBuilder.Entity("ApiPrueba.Models.Paciente", b =>
                {
                    ...
                    b.Property<bool?>("EstadoAfiliacion")
                        .HasColumnType("bit");

                    b.Property<string>("EstadoDelProcesoActual")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("NumeroSesionesAplicadas")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("UltimaValoracion")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("ApiPrueba.Models.AutorizacionSesiones", b =>
                {
                    b.HasOne("ApiPrueba.Models.OrdenMedica", "OrdenMedica")
                        .WithMany()
                        .HasForeignKey("IdOrdenMedica");

                    b.HasOne("ApiPrueba.Models.Paciente", "Paciente")
                        .WithMany("AutorizacionesSesiones")
            ...
            modelBuilder.Entity("ApiPrueba.Models.Cita", b =>
                {
                    ...
                    b.HasOne("ApiPrueba.Models.OrdenMedica", null)
                        .WithMany("Citas")
                        .HasForeignKey("OrdenMedicaIdOrdenMedica");

                    b.HasOne("ApiPrueba.Models.Paciente", null)
                        .WithMany("Citas")
                        .HasForeignKey("PacienteId");

                    b.HasOne("ApiPrueba.Models.Sala", null)
                        .WithMany("Citas")
            ...
            modelBuilder.Entity("ApiPrueba.Models.EquiposRequeridos", b =>
                {
                    ...
                    b.HasOne("ApiPrueba.Models.TipoServicio", "TipoServicio")
            ...
            modelBuilder.Entity("ApiPrueba.Models.TipoServicioEspecialidad", b =>
                {
                    ...
                    b.HasOne("ApiPrueba.Models.TipoServicio", "TipoServicio")
                        .WithMany("TipoServicioEspecialidades")
                        .HasForeignKey("IdTipoServicio")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ApiPrueba.Models.TipoServicio", b =>
                {
                    ...
                    b.Navigation("TipoServicioEspecialidades");
                });
            ...
            modelBuilder.Entity("ApiPrueba.Models.Paciente", b =>
                {
                    b.Navigation("AutorizacionesSesiones");
