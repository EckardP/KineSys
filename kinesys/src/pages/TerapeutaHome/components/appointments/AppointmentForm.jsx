...
export default function AppointmentForm({ onSubmit, onCancel }) {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm border border-border max-w-2xl">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-text-primary">Programar Nueva Cita</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-text-primary mb-1">Hora *</label>
            <input
              type="time"
              name="hora"
              value={formData.hora}
          ...
          <div>
            <label className="block text-sm font-medium text-text-primary mb-1">Sala</label>
            <select
              name="sala"
              value={formData.sala}
              onChange={handleChange}
        ...
        <div>
          <label className="block text-sm font-medium text-text-primary mb-1">Tipo de Cita</label>
          <select
            name="tipo"
            value={formData.tipo}
            onChange={handleChange}
