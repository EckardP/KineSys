  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => setShowForm(true)} className="bg-gray-500 hover:bg-gray-800">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 text-sm">Citas Realizadas</p>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            ...
            <Clock className="text-gray-900 opacity-20" size={40} />
          </div>
        </div>
      </div>
          ...
          <tbody>
            {upcomingAppointments.map((appt) => (
              <tr key={appt.id} className="border-b hover:bg-gray-50 transition-colors">
                ...
                <td className="px-6 py-4 text-sm text-gray-600">{appt.fecha}</td>
                <td className="px-6 py-4 text-sm text-gray-600">{appt.hora}</td>
                <td className="px-6 py-4 text-sm text-gray-600">{appt.tipo}</td>
                <td className="px-6 py-4 text-sm text-gray-600">Sala {appt.sala}</td>
